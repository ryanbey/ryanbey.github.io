...
document.
    getElementById('carousel-1-button-next')
    .addEventListener("click", function() {
        moveToNextSlide1();
    });

document.
    getElementById('carousel-1-button-prev')
        .addEventListener("click", function() {
        moveToPrevSlide1();
    });
...
document.
    getElementById('carousel-2-button-next')
    .addEventListener("click", function() {
        moveToNextSlide2();
    });

document.
    getElementById('carousel-2-button-prev')
        .addEventListener("click", function() {
        moveToPrevSlide2();
    });
 ...
 *******************************/
 ...
 document.
     getElementById('carousel-3-button-next')
     .addEventListener("click", function() {
         moveToNextSlide3();
     });
 
 document.
     getElementById('carousel-3-button-prev')
         .addEventListener("click", function() {
         moveToPrevSlide3();
     });
...
document.
    getElementById('carousel-4-button-next')
    .addEventListener("click", function() {
        moveToNextSlide4();
    });

document.
    getElementById('carousel-4-button-prev')
        .addEventListener("click", function() {
        moveToPrevSlide4();
    });
